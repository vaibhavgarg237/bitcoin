...
void CConnman::OpenNetworkConnection(const CAddress& addrConnect, bool fCountFailure, CSemaphoreGrant *grantOutbound, const char *pszDest, bool fScout, bool fFeeler, ConnectionType conn_type, bool block_relay_only)
{
    assert(conn_type != ConnectionType::INBOUND);
