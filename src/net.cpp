...
void CConnman::OpenNetworkConnection(const CAddress& addrConnect, bool fCountFailure, CSemaphoreGrant *grantOutbound, const char *pszDest, bool fScout, ConnectionType conn_type)
{
    assert(conn_type != ConnectionType::INBOUND);
