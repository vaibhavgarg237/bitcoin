...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-rebroadcast", strprintf("Enable rebroadcast of transactions, incase they may not have saturated the network. (default: %u)", DEFAULT_REBROADCAST_ENABLED), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
