...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-rebroadcast", strprintf("Enable transaction rebroadcast. (default: %u)", DEFAULT_REBROADCAST_ENABLED), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
